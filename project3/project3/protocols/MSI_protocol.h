...
/** Cache states.  */
typedef enum {
    MSI_CACHE_I = 1, //invalid state
    MSI_CACHE_IS, //transitioning from invalid to shared state
    MSI_CACHE_IM, //transitioning from invalid to modified state
    MSI_CACHE_SM, //transitioning from shared to modified state
    MSI_CACHE_S, //shared state
    MSI_CACHE_M //modified state
} MSI_cache_state_t;
